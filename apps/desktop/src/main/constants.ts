...
export const DESKTOP_SESSION_TIMEZONE_NOTICE_CHANNEL = "desktop:session-timezone:notice" as const;
export const DESKTOP_SESSION_TIMEZONE_SETTING_CHANNEL = "desktop:session-timezone:setting" as const;
export const DESKTOP_SESSION_TIMEZONE_MODE_CHANNEL = "desktop:session-timezone:mode" as const;
