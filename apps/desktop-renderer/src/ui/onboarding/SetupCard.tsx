...
export const BUTTON_OUTLINE_SM = `${BUTTON_SM} border-line-2 bg-surface text-ink shadow-[var(--edge),var(--elev-1)] hover:bg-surface-2`;
...
export const SETUP_HINT_CLASS = "mt-[7px] block text-[11.5px] leading-normal text-ink-3";

export const SETUP_FIELD_CLASS =
  "h-[30px] w-full max-w-[236px] rounded-ctl border border-line-2 bg-surface px-[11px] text-sm text-ink shadow-[var(--edge),var(--elev-1)] disabled:opacity-64";
