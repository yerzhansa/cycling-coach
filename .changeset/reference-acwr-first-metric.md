...
User-facing: ACWR (load freshness ratio) now computed in the reference layer — the first load-management metric with bit-identical parity against the upstream protocol.
